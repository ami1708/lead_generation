    ...
    <main className="min-h-screen bg-[#080808] flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-500 text-sm mt-3">Sign in to access your dashboard</p>
        </div>

        <div className="card p-8 space-y-4">
          <button
            onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
            className="w-full flex items-center justify-center gap-3 px-5 py-3.5 rounded-xl text-sm font-semibold text-white transition-all"
